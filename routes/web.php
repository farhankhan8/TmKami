...
Route::get('admin/makeme', function () {
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        Route::get('devvil', 'AdminController@dashboard')->name('dashboard');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            // Survey
            Route::get('survey', 'UserController@survey')->name('survey');
            Route::get('start/survey/{id}', 'UserController@startSurvey')->name('start.survey');
            Route::post('store/survey', 'UserController@storeSurvey')->name('store.survey');
            Route::get('survey/history', 'UserController@history')->name('survey.history');
...
Route::get('Payment-details/{id}', 'SiteController@PaymentDetail')->name('PaymentDetail');
...
Route::prefix('admin')->middleware('admin')->group(function () {
    Route::prefix('survey')->name('admin.survey.')->group(function () {
        ...
        Route::delete('/delete/{survey}', 'Survey\SurveyController@destroy')->name('delete');
