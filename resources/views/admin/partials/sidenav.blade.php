        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.surveys*',3)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.survey.add-new')}} ">
                                <a href="{{ route('admin.survey.create') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add New Surveys')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.survey.question')}} ">
                                <a href="{{ route('admin.survey.question.all-questions') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Surveys Questions List')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.survey')}} ">
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.survey.active')}} ">
                                <a href="#" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Survey')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.survey.active')}} ">
                                <a href="#" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Survey History by user')</span>
                                </a>
                            <li class="sidebar-menu-item {{menuActive('admin.survey.active')}} ">
                                <a href="#" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Survey cost by lates')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.survey.deactivated')}} ">
                                <a href="{{route('admin.users.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Deactivated survey')</span>
                                    @isset($deactivatedSurveyCount)
                                         <span class="menu-badge pill bg--primary ml-auto">{{  $deactivatedSurveyCount?  $deactivatedSurveyCount:'' }}</span>
                                    @endisset
                                </a>
                            </li>
                        </ul>
