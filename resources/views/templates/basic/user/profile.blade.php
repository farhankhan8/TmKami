                               ...
                               <select class="form-control form-control-lg" name="country">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control form-control-lg" placeholder="@lang('Address')" value="{{ __(optional($user->address)->address) }}">        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label>@lang('Post_office')</label>
                                        <input type="text" name="post_office" class="form-control form-control-lg" placeholder="@lang('post office')" value="{{ __(optional($user->address)->post_office) }}">        
                                    </div>
                                </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label>@lang('Para')</label>
                                        <input type="text" name="para" class="form-control form-control-lg" placeholder="@lang('para')" value="{{ __(optional($user->address)->para) }}">        
                                    </div>
                                </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label>@lang('State')</label>
                                        <input type="text" name="state" class="form-control form-control-lg" placeholder="@lang('State')" value="{{ __(optional($user->address)->state) }}">        
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
