...
<head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1855956289660339"
    ...
    })(window, document, "clarity", "script", "8grfc1rgcq");
</script>
...
@php echo fbcomment() @endphp
  ...
  <header class="header">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            @else
              <ul class="navbar-nav main-menu ml-auto">
                ...
                <li class="menu_has_children"><a href="#0">@lang('Ads')</a>
                  <ul class="sub-menu">
                        <li><a href="{{ route('user.ptc.index') }}">@lang('Ads')</a></li>
                                        <li><a href="{{ route('user.survey') }}">@lang('Take Survey')</a></li>
                                        <li><a href="{{ route('user.survey.history') }}">@lang('Survey History')</a>
                                        </li>
                                        <li><a href="{{ route('user.ptc.clicks') }}">@lang('Ads History')</a></li>
                  </ul>
                </li>
                ...
                <li class="menu_has_children"><a href="#0">@lang('Referral')</a>
                  <ul class="sub-menu">
                    <li><a href="{{ route('user.commissions') }}">@lang('Commissions History')</a></li>
                    <li><a href="{{ route('user.referred') }}">@lang('Referred Link & Users')</a></li>
                  </ul>
                </li>
                ...
                <li class="menu_has_children"><a href="#0">@lang('Account')</a>
                  <ul class="sub-menu">
                    ...
                    <li><a href="{{ route('user.Guide') }}">@lang('Earning Guide')</a></li>
    ...
    <marquee bgcolor="#d9d9ff"> <h3> Good news, Our Survey is ready to view, You can check. You can start earn from survey in the next week Insha-Allah. Pray for us. Refer and check our plan latest update of ours. best of luck </h3> </marquee>
  </header>
  <!-- header-section end  -->
@yield('content')
